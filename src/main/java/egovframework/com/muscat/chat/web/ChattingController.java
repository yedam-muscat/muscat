	...
	public class ChattingController {
	    ...
	    public String chatMain(String roomId,HttpSession session, ModelMap model) {
	    ...
	    public Map<String, String> insertRoom(@RequestBody List<String> users, HttpSession session) {
		    ...
		    alarm.setNtcnChId(roomId);
		    alarm.setLinkUrl("/muscat/chat/chat.do?roomId=" + roomId); //  알림 클릭 시 이동할 링크
		    
		    for(int i=0; i < users.size(); i++) {
		    	alarm.setMberId(users.get(i));
